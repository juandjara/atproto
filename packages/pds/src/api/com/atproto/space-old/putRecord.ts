...
export default function (server: Server, ctx: AppContext) {
  server.com.atproto.space.putRecord({
    ...
    handler: async ({ auth, input }) => {
      // TODO, deny certain NSIDs, they must be C_UD through procedures
      // (space, group, relationship)
      ...
      const swapCommitCid = undefined
      const swapRecordCid = undefined
