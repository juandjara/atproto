...
export default function (server: Server, ctx: AppContext) {
  server.com.atproto.space.listSpaces({
    ...
    handler: async ({ auth, params }) => {
      ...
      try {
        ...
        var { cursor, limit, parent, repo, reverse, zookie } = params;
        ...
        await checkPermission({
          ...
          subjectId: reqDidSid,
          permission: "space_list",
          objectType,
          objectId,
          collectionOp: LEX.ids.ComAtprotoSpaceListSpaces,
