...
export default function (server: Server, ctx: AppContext) {
  server.com.atproto.space.updateRelation({
    ...
    handler: async ({ auth, input }) => {
      ...
      try {
        ...
        var { parent, record, repo, rkey, swapCid, validate, zookie } =
          input.body;
        ...
        await checkPermission({
          ...
          objectType,
          objectId,
          collectionOp: LEX.ids.ComAtprotoSpaceUpdateRelation,
